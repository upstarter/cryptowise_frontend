...
class CurateComponent extends React.Component {
  constructor() {
    super();
    this.state = {
        ...
        <div className="dark-wrap">
          <section id="curate" className={classes.data_scientists}>
            <div id="curate-content" >
              <div id='curate-header'>
                <div id="header-title">
                  <h1 id="title">
                    <span style={{color: `${colors.silver}`}}>The world needs your data science wisdom.</span>
                  </h1>
                </div>
                <div id="words">
                  <div id="blurb">
...
export default injectSheet(styles)(CurateComponent)
