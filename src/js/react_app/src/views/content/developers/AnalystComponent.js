          ...
          <section id="analyst" className={classes.analysts}>
            <div id="analyst-content">
                ...
                <div id="header-title">
                  <h1 id="title">
                    <span style={{ color: `${colors.silver}` }}>
                      The world needs your investment wisdom.
                    </span>
                  </h1>
                </div>
                <div id="words">
                  <div id="blurb">
                    <h5>Join the top crypto network for:</h5>
              ...
              <div id="analyst-list">
                ...
                <ul>
                  <li>
                    Free access to ecosystem leading peer-to-peer robo-advisory
                    services where serious investors discover, implement, curate
                    and enrich next-generation decentralized methods of
                    strategic asset analysis.
                  </li>
                  <li>
                    Play a part in leading US crypto-economic research &
                    development in the growing blockchain/defi ecosystem.
                  </li>
                  <li>
                    Access our community wisdom repository: ontologies, systems,
                    strategies, tactics, insights, and viewpoints for investment
                    engineering optimization.
                  </li>
                  {/* <li>Crowdsourced token project intelligence.</li> */}
                  <li>
                    Early contributors get premium access to closed Beta
                    Features.
                  </li>
